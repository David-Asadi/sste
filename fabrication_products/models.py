...
class Fabrication_Product(models.Model):

    class Meta:
        verbose_name_plural = "Fabrication Products"
        verbose_name = "Fabrication Product item"
    title = models.CharField(max_length=200)
    description = RichTextField(null=True, blank=True)
    sub_category = models.ForeignKey(Fab_Cat, null=True, on_delete=models.CASCADE)
